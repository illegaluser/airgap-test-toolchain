...
* **Zero-Touch QA v4.1:** 14대 확장 Action DSL(Upload, Drag, Scroll, Network Mocking 지원) + Dify Brain + 3-Flow(Doc/Chat/Convert) 진입 + 모듈화된 Python 패키지(`zero_touch_qa/`) + 7단계 시맨틱 탐색 + 3단계 하이브리드 Self-Healing + HTML 리포트 + Regression Test 자동 생성
