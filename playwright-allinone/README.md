...
어디서 실행하든 `./build.sh --redeploy` 한 번이면 빌드 → 컨테이너 → provision → 호스트 agent → Recording UI(18092) → 호스트 Replay UI(18093) 까지 자동 완료. 휴대용 Replay UI(18099) 는 받는 PC 가 별도 zip 풀고 띄움.
