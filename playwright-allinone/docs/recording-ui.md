...
9. [최근 세션 — 세션 목록 / 일괄 삭제](#9-최근-세션--세션-목록--일괄-삭제)
10. [자동 정리 기능 (codegen 노이즈 제거)](#10-자동-정리-기능-codegen-노이즈-제거)
11. [파일 구조 — `recordings/<id>/`](#11-파일-구조--recordingsid)
12. [자주 발생하는 문제와 원인](#12-자주-발생하는-문제와-원인)
13. [API 요약](#13-api-요약)
