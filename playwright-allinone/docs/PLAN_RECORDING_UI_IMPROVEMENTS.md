...
5. **결과 패널 군** — Scenario JSON / Original Script / Run-log + Screenshots /
...
```text
GET  /recording/sessions/{sid}/run-log              (R1 — P1)
GET  /recording/sessions/{sid}/screenshot/{name}    (R1 — P1, path-traversal 방어)
