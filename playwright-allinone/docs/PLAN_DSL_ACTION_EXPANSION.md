...
| 액션 | 브랜치 | 상태 |
| --- | --- | --- |
| dialog_choose | `feat/dsl-action-dialog-choose` | **완료** — executor 핸들러 + 픽스처 3종 + 테스트 8/8 + 인접 회귀 212/212 |
| performance | (예정) | pending |
| visual_diff | (예정) | pending |
| storage_read | (예정) | pending |
| cookie_verify | (예정) | pending |
